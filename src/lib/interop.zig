...
pub const PIN_MODE_NONE: u8 = 0;
pub const PIN_MODE_OUTPUT: u8 = 1;
pub const PIN_MODE_INPUT_PULL_UP: u8 = 2;
pub const PIN_MODE_INPUT_PULL_DOWN: u8 = 3;
pub const PIN_MODE_INPUT_PULL_NONE: u8 = 4;
pub const PIN_MODE_PWM: u8 = 5;
pub const PIN_MODE_ADC: u8 = 6;
pub const PIN_MODE_DAC: u8 = 7;
pub const InternalPinMode = u8;
pub const struct_SimulatorFuncs = extern struct {
    pin_mode: ?*const fn (u8, InternalPinMode) callconv(.C) void = @import("std").mem.zeroes(?*const fn (u8, InternalPinMode) callconv(.C) void),
    set_pin: ?*const fn (u8, u8) callconv(.C) void = @import("std").mem.zeroes(?*const fn (u8, u8) callconv(.C) void),
    toggle_pin: ?*const fn (u8) callconv(.C) void = @import("std").mem.zeroes(?*const fn (u8) callconv(.C) void),
    read_pin: ?*const fn (u8) callconv(.C) u8 = @import("std").mem.zeroes(?*const fn (u8) callconv(.C) u8),
    set_bus: ?*const fn ([*c]u8, u16) callconv(.C) void = @import("std").mem.zeroes(?*const fn ([*c]u8, u16) callconv(.C) void),
    @"error": ?*const fn ([*c]const u8) callconv(.C) void = @import("std").mem.zeroes(?*const fn ([*c]const u8) callconv(.C) void),
    ...
    pwm_freq: ?*const fn (u8, f32) callconv(.C) void = @import("std").mem.zeroes(?*const fn (u8, f32) callconv(.C) void),
    pwm_rcy: ?*const fn (u8, f32) callconv(.C) void = @import("std").mem.zeroes(?*const fn (u8, f32) callconv(.C) void),
    read_ana: ?*const fn (u8) callconv(.C) u16 = @import("std").mem.zeroes(?*const fn (u8) callconv(.C) u16),
    write_ana: ?*const fn (u8, u16) callconv(.C) void = @import("std").mem.zeroes(?*const fn (u8, u16) callconv(.C) void),
    can_write: ?*const fn (u16, u8, [*c]u8) callconv(.C) void = @import("std").mem.zeroes(?*const fn (u16, u8, [*c]u8) callconv(.C) void),
    get_jog: ?*const fn (...) callconv(.C) u8 = @import("std").mem.zeroes(?*const fn (...) callconv(.C) u8),
    get_cod: ?*const fn (...) callconv(.C) i8 = @import("std").mem.zeroes(?*const fn (...) callconv(.C) i8),
};
pub const SimulatorFuncs = struct_SimulatorFuncs;
pub extern fn pin_mode(pin: u8, mode: InternalPinMode) void;
pub extern fn set_pin(pin: u8, state: u8) void;
pub extern fn toggle_pin(pin: u8) void;
pub extern fn read_pin(pin: u8) u8;
pub extern fn set_bus(pins: [*c]u8, state: u16) void;
pub extern fn @"error"(msg: [*c]const u8) void;
...
pub extern fn pwm_freq(pin: u8, freq: f32) void;
pub extern fn pwm_rcy(pin: u8, rcy: f32) void;
pub extern fn read_ana(pin: u8) u16;
pub extern fn write_ana(pin: u8, value: u16) void;
pub extern fn can_write(ident: u16, size: u8, tab_data: [*c]u8) void;
pub extern fn get_jog(...) u8;
pub extern fn get_cod(...) i8;
...
pub const INC_PINNAMES_H_ = "";
pub const PA_0 = @as(c_int, 0x00);
pub const PA_1 = @as(c_int, 0x01);
pub const PA_2 = @as(c_int, 0x02);
pub const PA_3 = @as(c_int, 0x03);
pub const PA_4 = @as(c_int, 0x04);
pub const PA_5 = @as(c_int, 0x05);
pub const PA_6 = @as(c_int, 0x06);
pub const PA_7 = @as(c_int, 0x07);
pub const PA_8 = @as(c_int, 0x08);
pub const PA_9 = @as(c_int, 0x09);
pub const PA_10 = @as(c_int, 0x0A);
pub const PB_0 = @as(c_int, 0x10);
pub const PB_1 = @as(c_int, 0x11);
pub const PB_2 = @as(c_int, 0x12);
pub const PB_3 = @as(c_int, 0x13);
pub const PB_4 = @as(c_int, 0x14);
pub const PB_5 = @as(c_int, 0x15);
pub const PB_6 = @as(c_int, 0x16);
pub const PB_7 = @as(c_int, 0x17);
pub const PF_0 = @as(c_int, 0x50);
pub const PF_1 = @as(c_int, 0x51);
pub const NC = @as(c_int, 0xFF);
pub const _INC_IDENT_IHM_H_ = "";
pub const LCD_CHAR0 = @as(c_int, 0x700);
pub const LCD_CHAR1 = @as(c_int, 0x701);
pub const LCD_CHAR2 = @as(c_int, 0x702);
pub const LCD_CHAR3 = @as(c_int, 0x703);
pub const LCD_OVERFLOW = @as(c_int, 0x77E);
pub const LCD_CLEAR = @as(c_int, 0x77F);
pub const JOG_REQ = @as(c_int, 0x790);
pub const JOG_DATA = @as(c_int, 0x791);
pub const COD_REQ = @as(c_int, 0x7A0);
pub const COD_DATA = @as(c_int, 0x7A1);
pub const BAR_WRITE = @as(c_int, 0x7B0);
