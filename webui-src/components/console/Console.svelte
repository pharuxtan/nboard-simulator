<script>
  ...
  showHelp = function showHelp(){
    ...
    xterm.write([
      ...
      " - Ctrl+S : Sauvegarde le main que vous pouvez éditer dans l'onglet editeur de code",
      " - Ctrl+C : Copie du texte sélectionné dans l'onglet console ou editeur de code",
      " - Ctrl+V : Colle du texte dans l'onglet editeur de code",
