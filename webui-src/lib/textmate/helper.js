...
// https://github.com/microsoft/vscode/blob/main/src/vs/workbench/services/textMate/common/TMHelper.ts
...
export const TMToMonacoToken = function TMToMonacoToken(theme, scopes){
...
export function convertTheme(theme){
  ...
  return {
    base: theme.type === 'light'   ? 'vs'       :
          theme.type === 'hcLight' ? 'hc-light' :
          theme.type === 'hcDlack' ? 'hc-black' :
          /* else */                 'vs-dark'  ,
    inherit: false,
    rules,
    colors: theme.colors || {},
